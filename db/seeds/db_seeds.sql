...
(2, 'Oscar', 'Oscar likes to snooze with you in the morning, and get some belly rubs while hes there. He doesnt mind getting picked up occasionally, but hes not a hugger in general. Hes quite affectionate though, and just shows it in different ways.', 'http://dummyimage.com/202x225.bmp/dddddd/000000', '2019-05-09 00:44:16', '13000', 'territorial', 'leopard'),

(3, 'Misty', 'Misty and Coco haved lived together for 4 years. We would love to place these ladies together if we can find that very special home for them. They lived with a lion in their previous home. Misty is more easy going than Coco.', 'http://dummyimage.com/182x111.bmp/dddddd/000000', '2019-10-05 16:03:11', '4000', 'easygoing', 'cougar'),
...
(3, 'Toby', 'Toby has a medium-length white coat with a gray tabby hood and tail with a spot on his back.  He has a short, broad face and is fairly muscular.  He is very excitable, and will jump on any available lap.', 'http://dummyimage.com/184x118.bmp/ff4444/ffffff', '2019-04-15 16:13:44', '6000', 'excitable', 'jaguar'),

(4, 'Rusty', 'Rusty a short seal tabby point coat.  He has a medium-length, average-width face and is quite thin.  He likes to roll around, and lay in the sun.', 'http://dummyimage.com/149x115.bmp/ff4444/ffffff', '2020-01-11 15:59:05', '4500', 'lazy', 'leopard'),

(5, 'Pumpkin', 'Pumpkin has a short, narrow face and is of average weight.  She is a picky eater, pounces anything that moves, and is very friendly.', 'http://dummyimage.com/213x126.bmp/cc0000/ffffff', '2020-03-10 10:11:37', '5000', 'friendly', 'cougar');
